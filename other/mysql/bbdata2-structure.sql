...
-- Schema bbdata2
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bbdata2` ;
USE `bbdata2` ;
...
DELIMITER $$
USE `bbdata2`$$
CREATE DEFINER=`bbdata-admin`@`localhost` PROCEDURE `login`(IN userId INT, IN clearpass VARCHAR(45), OUT ok BOOL)
BEGIN
...
DELIMITER $$
USE `bbdata2`$$
CREATE DEFINER=`bbdata-admin`@`localhost` PROCEDURE `rebuild_mat_view`()
BEGIN
    ...
    SELECT DISTINCT * FROM (
        ...
        WHERE o.ugrp_id = ug.ugrp_id
        UNION
        SELECT ug.user_id, og.object_id, ug.is_admin 
        FROM users_ugrps ug, objects_ogrps og, rights r 
        WHERE ug.ugrp_id = r.ugrp_id and og.ogrp_id = r.ogrp_id 
    ) tmp;
END$$
...
FROM (
    ...
    UNION
    SELECT uug.user_id, og.id AS 'ogrp_id' 
    from users_ugrps uug join ogrps og on uug.ugrp_id = og.ugrp_id AND uug.ugrp_id = 1
) read_perms;
...
FROM (
    ...
    FROM users_ugrps uug JOIN ogrps og ON uug.ugrp_id = 1 AND uug.is_admin = 1
) write_perms;
USE `bbdata2`;
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `ugrps_ADEL` AFTER DELETE ON `ugrps` FOR EACH ROW
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER objects_AUPD AFTER UPDATE ON objects FOR EACH ROW
BEGIN
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `objects_ADEL` AFTER DELETE ON `objects` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `objects_ogrps_AINS` AFTER INSERT ON `objects_ogrps` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `objects_ogrps_ADEL` AFTER DELETE ON `objects_ogrps` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `rights_AINS` AFTER INSERT ON `rights` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `rights_ADEL` AFTER DELETE ON `rights` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `users_ugrps_AINS` AFTER INSERT ON `users_ugrps` FOR EACH ROW
	CALL rebuild_mat_view() */$$
...
USE `bbdata2`$$
/*!50003 CREATE*/ /*!50017 DEFINER=`bbdata-admin`@`localhost`*/ /*!50003 TRIGGER `users_ugrps_ADEL` AFTER DELETE ON `users_ugrps` FOR EACH ROW
	CALL rebuild_mat_view() */$$
